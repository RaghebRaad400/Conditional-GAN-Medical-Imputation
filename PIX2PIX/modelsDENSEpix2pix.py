...
def generatorpix2pix(Input_W=64,Input_H=64,Input_C=1,Z_Dim=50,k0=32,reg_param=1.0e-7,act_param=0.2,out_channels=16,layers=3,ADDtanh=1,Etype=1):
  input_X = keras.Input(shape=(Input_W,Input_H,Input_C))
  input_Z = keras.Input(shape=(1,1,Z_Dim))
  ...
  X2  = DownSample(input_X=X1,k=2*k0,reg_param=reg_param,act_param=act_param)
  X2  = DenseBlock(input_X=X2,input_Z=input_Z,normalization='bn',reg_param=reg_param,act_param=act_param,out_channels=out_channels,layers=layers)

  X3  = DownSample(input_X=X2,k=4*k0,reg_param=reg_param,act_param=act_param)
  X3  = DenseBlock(input_X=X3,input_Z=input_Z,normalization='bn',reg_param=reg_param,act_param=act_param,out_channels=out_channels,layers=layers)

  # Final downsampling + ResBlock (not to be concatenated)
  X4  = DownSample(input_X=X3,k=8*k0,reg_param=reg_param,act_param=act_param)
  X4  = DenseBlock(input_X=X4,input_Z=input_Z,normalization='bn',reg_param=reg_param,act_param=act_param,out_channels=out_channels,layers=layers)

  # Coarsest level DenseBlock
  X5  = DenseBlock(input_X=X4,input_Z=input_Z,normalization='bn',reg_param=reg_param,act_param=act_param,out_channels=out_channels,layers=layers)
  
  # Upsampling + DenseBlock
  X6  = UpSample(input_X=X5,k=8*k0,reg_param=reg_param,act_param=act_param)
  X6  = DenseBlock(input_X=X6,input_Z=input_Z,normalization='bn',reg_param=reg_param,act_param=act_param,out_channels=out_channels,layers=layers)

  # Upsampling + Concat + DenseBlock
  X7  = UpSample(input_X=X6,k=4*k0,concat=True,old_X=X3,reg_param=reg_param,act_param=act_param)
  X7  = DenseBlock(input_X=X7,input_Z=input_Z,normalization='bn',reg_param=reg_param,act_param=act_param,out_channels=out_channels,layers=layers)

  X8  = UpSample(input_X=X7,k=2*k0,concat=True,old_X=X2,reg_param=reg_param,act_param=act_param)
  X8  = DenseBlock(input_X=X8,input_Z=input_Z,normalization='bn',reg_param=reg_param,act_param=act_param,out_channels=out_channels,layers=layers)

  X9  = UpSample(input_X=X8,k=k0,concat=True,old_X=X1,upsample=False,reg_param=reg_param,act_param=act_param)
  X9  = DenseBlock(input_X=X9,input_Z=input_Z,normalization='bn',reg_param=reg_param,act_param=act_param,out_channels=out_channels,layers=layers)
